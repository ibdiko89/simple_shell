 ...
 * @next: A pointer pointing to another struct list_s.
 */
 ...
 * @next: A pointer pointing to another struct alias_s.
 */
...
/* Input Helpers or functions  prototypes  */
...
/* String functions and prototypes */
